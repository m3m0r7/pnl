...
project-root/
  ...
  @pnlx/                       ← everything below is generated
    ...
    ide-helper.php
    pnlx-pathmap.json
    runtime/                    ← a copy of the Pnlx SDK runtime
    composites/                 ← composed classes from `pnl compose` (if any)
    packages/
      vendor/
        package/
...
- `@pnlx/ide-helper.php`: a not-loaded-at-runtime stub that gives IDEs and static analysis the generated entity signatures.
- `@pnlx/runtime/`: a copy of the `Pnlx` SDK runtime, so the autoloader works without a Composer autoloader.
- `@pnlx/composites/`: classes generated by [`pnl compose`](commands.md#pnl-compose-members---as-class), each fusing several extensions into one shared FFI scope (absent until you run it).
